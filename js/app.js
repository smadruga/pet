...
$(document).ready(function () {
    ...
    $('input:radio[id="radio"]').change(function() {
        ...
        $('#radio'+ $(this).val()).addClass(btn);

    });    
    
    $('input:radio[id="radiogeral"]').change(function() {

        $('label[name="radiogeral"]').removeClass();
        $('label[name="radiogeral"]').addClass("btn btn-default");
        $('#radiogeral'+ $(this).val()).addClass("btn btn-warning active");
...
$('#calendar').fullCalendar({
    ...
    eventAfterRender: function (event, element) {
        ...
        if (event.Evento == 1)
            ...
            var title = "<b>" + event.title + "</b><br><b>Pet:</b> " + event.Pet + "<br><b>Procedimento:</b> " + event.Procedimento + "<br><b>Veterinário:</b> " + event.Veterinario;
